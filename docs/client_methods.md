...
این سند به‌صورت خودکار تولید شده و شامل تمامی متدهای عمومی به‌همراه توضیحات کامل آن‌ها می‌باشد.

> **توجه:** متدهای خصوصی و داخلی (با پیشوند `_`) در این لیست گنجانده نشده‌اند.
...
---
### `get_contacts_updates(self: 'rubpy.Client', state: Union[str, int, NoneType] = 1748353298) -> rubpy.types.update.Update`
...
---
### `get_folders(self: 'rubpy.Client', last_state: Union[int, str] = 1748353298) -> rubpy.types.update.Update`
...
---
### `get_messages_updates(self: 'rubpy.Client', object_guid: str, state: int = 1748353298) -> rubpy.types.update.Update`
